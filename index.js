function NavText1() {
    ...
    document.getElementById("OptionContainer2").style.display = "none";
    document.getElementById("CardContainer3").style.display = "none";
    document.getElementById("OptionContainer3").style.display = "none";
}
...
function NavText2() {
    ...
    document.getElementById("OptionContainer2").style.display = "flex";
    document.getElementById("CardContainer3").style.display = "none";
    document.getElementById("OptionContainer3").style.display = "none";
}
...
function NavText3() {
    ...
    document.getElementById("OptionContainer3").style.display = "flex";
}
